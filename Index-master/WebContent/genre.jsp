       ...
       <ul>
        ...
        <li><a href="#">Genre</a>
            <ul>
                ...
                <li><a href="genreList.jsp1">Poems</a></li>
                <li><a href="genreList.jsp2">Romantic</a></li>
                <li><a href="genreList.jsp1">Short Story</a></li>
                <li><a href="genreList.jsp2">Others</a></li>
            </ul>
            </li>
